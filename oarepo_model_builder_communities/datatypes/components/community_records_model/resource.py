...
class CommunityRecordsResourceModelComponent(ResourceModelComponent):
    ...
    def before_model_prepare(self, datatype, *, context, **kwargs):
        ...
        config.setdefault(
            "base-classes",
            [
                "oarepo_communities.resources.community_records.config.CommunityRecordsResourceConfig"
            ],
        )
        ...
        resource.setdefault(
            "base-classes",
            [
                "oarepo_communities.resources.community_records.resource.CommunityRecordsResource"
            ],
        )
